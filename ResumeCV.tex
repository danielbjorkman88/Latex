...
\par{\centering
    ...
    \phone \enspace +46737784759 \textbullet \enspace \Envelope \enspace dabjor@kth.se \textbullet   \href{http://www.linkedin.com/in/danielbjorkman88}{\includegraphics[width=10ex]{Logo-2C-54px-TM.png}} \href{http://www.linkedin.com/in/danielbjorkman88}{Profile} \\ \\
...
Other & Linux, SQL, Git, SVN, Spyder, Visual Studios,  MS Office,  \LaTeX \\ %{\fb \LaTeX}\setmainfont[SmallCapsFont=Fontin-SmallCaps.otf]{Fontin.otf} \\
