...
\footnotesize{Achievements:} & \footnotesize{ \textbullet Work permits the SPS to deliver a fourfold increased beam intensity [1,2].}\\
 ...
 % &   \footnotesize{ \textbullet Improved collision modelling and radiation description for the ATLAS experiment. } \\ \\
  ...
  &   \footnotesize{ \textbullet Up to twofold precision obtained for all simulation studies of the ATLAS experiment.  } \\ \\



%  &   \footnotesize{ \textbullet Improved collision modelling and radiation description for the ATLAS experiment. } \\ \\
 
% Solved physics related operations obstacles through 3D modelling and python pre post-processing of Monte Carlo transport simulations

%to irradiation facilities through
...
\end{enumerate}
\hspace{7.5mm} Co-authored Submission: \
\begin{itemize}
...
Other & Linux, SQL, Git, Spyder, Visual Studios,  MS Office,  \LaTeX \\ %{\fb \LaTeX}\setmainfont[SmallCapsFont=Fontin-SmallCaps.otf]{Fontin.otf} \\
